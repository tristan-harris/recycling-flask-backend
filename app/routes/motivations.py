...
from . import RouteErrors, db_controller, create_resource, get_resource, \
    get_resource_all, update_resource, delete_resource
...
def update_motivation(user_id:int):
    ...
    return update_resource(Motivation, "user_id", user_id, request_data, current_user.id)
