...
from . import RouteErrors, db_controller, create_resource, \
    get_resource, get_resource_all, update_resource, delete_resource
...
def upload_bin_image(id:int):
    ...
    image_path = get_image_upload_path(id, current_app.config["UPLOADS_DIRECTORY"], Constants.BIN_IMAGES_DIRECTORY)
...
def get_bin_whitelist(id:int):
    ...
    return {"whitelist": True, "recyclables": [recyclable.to_dict() for recyclable in recyclables]}
